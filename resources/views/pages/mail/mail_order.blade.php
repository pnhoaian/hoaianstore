        ...
        <div class="col-md-12">
            ...
            <div class="row" style="background: cadetblue;padding: 15px"> 
                ...
                <div class="col-md-6" style="text-align: center; color: #FFF;font-weight: bold;font-size: 30px;">
                    ...
                    <h6 style="margin:0"> PHỤ KIỆN SẠC, DÂY CÁP CHÍNH HÃNG - UY TÍN - CHẤT LƯỢNG - GIÁ THÀNH TỐT NHẤT</h6>
                </div>

                <div class="col-md-6 logo" style="color: #FFF">
                    <p>Chào bạn, <strong style="color: #FFF;text-decoration: underline">{{ $shipping_array['customer_name'] }}</strong></p>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div>
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        {{-- khi chưa áp dụng khuyến mãi --}}
                        <p style="color: #FFF"> Tổng thanh toán:
